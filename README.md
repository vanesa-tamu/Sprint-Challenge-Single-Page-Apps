...
> Answer:`The main benefit stems from better user experience. Since there are no network requests being made as the user navigates througout the application, then the user is less likelike to experience lags or refreshed pages` 
